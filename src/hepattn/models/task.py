...
class HepfObjectValidTask(Task):
    def __init__(
        self,
        name: str,
        input_object: str,
        ...
        # Internal
        self.inputs = [input_object + "_embed"]
        self.outputs = [output_object + "_logit", output_object + "_prob"]
        self.net = class_net

    def forward(self, x: dict[str, Tensor]) -> dict[str, Tensor]:
        # Network projects the embedding down into a scalar
        x_logit = self.net(x[self.input_object + "_embed"])
        return {self.output_object + "_logit": x_logit, self.output_object + "_prob": x_logit.sigmoid()}
...
class HepfObjectHitMaskTask(Task):
    def __init__(
        self,
        name: str,
        input_constituent: str,
